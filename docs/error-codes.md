...
| 34 |  | Systemd OS is required for OpenTelemetry Collector installation |
| 35 |  | Previous OpenTelemetry Collector service in the system, won't install |
| 36 |  | OpenTelemetry Collector service not running |
| 37 |  | OpenTelemetry Collector installation requires uuidgen |
